...
namespace SecretSantaServer.Migrations
{
    ...
    [Migration("20260131150154_remove_refresh_key")]
    partial class remove_refresh_key
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SecretSantaServer.Models.Assignment", b =>
                {
                    ...
                    b.HasKey("GameId", "RecipientId", "SantaId")
                        .HasName("pk_assignments");

                    b.HasIndex("RecipientId")
                        .HasDatabaseName("ix_assignments_recipient_id");
